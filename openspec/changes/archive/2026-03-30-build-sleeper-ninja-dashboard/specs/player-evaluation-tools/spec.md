...
The system SHALL compare players being sent and received and report category-level impact for the active league.
...
The system SHALL let users search for a player and inspect detailed metrics, trends, and league-relative context.
